...
public class SessaoGinasticaBO {
	...
	public void atualizarBo(SessaoGinastica sessaoGinastica) throws ClassNotFoundException, SQLException {
		SessaoGinasticaDAO sessaoGinasticaDao = new SessaoGinasticaDAO();
		sessaoGinasticaDao.atualizar(sessaoGinastica);
	}

	public void deletarBo(int id) throws ClassNotFoundException, SQLException {
		SessaoGinasticaDAO sessaoGinasticaDao = new SessaoGinasticaDAO();
		sessaoGinasticaDao.deletar(id);
	}
