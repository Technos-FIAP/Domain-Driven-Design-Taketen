...
//);
	...
	public String atualizar(HistoricoSaude historicoSaude) throws SQLException {
		...
		stmt.setString(1, historicoSaude.getDataRegistro());
		stmt.setString(2, historicoSaude.getDescricaoEstresse());
		stmt.setString(3, historicoSaude.getDescricaoPostura());
		stmt.setDouble(4, historicoSaude.getNumeroHorasSedentarias());
		stmt.setString(5, historicoSaude.getDescricaoLesoes());
		stmt.setInt(6, historicoSaude.getIdUsuario());
